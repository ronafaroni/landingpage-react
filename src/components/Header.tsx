...
const Header = () => {
  return (
    <header
      className='h-16 grid grid-cols-1 items-center md:h-20
    lg:h-24'
    >
      <div className='container flex justify-between lg:grid lg:grid-cols-[1fr,3fr,1fr]'>
                        ...
                        {submenu.map(({ href, icon, label, desc }, index) => (
                          <li key={index}>
                            <NavigationMenuLink asChild>
                              ...
                              >
                                <div
                                  className='w-10 h-10 bg-foreground/10 rounded-sm
                                shadow-sm border-t border-foreground/5 flex-shrink-0
        ...
        <Popover>
          ...
          <PopoverContent
            ...
            border-foreground/5 border-x-0 border-b-0 
