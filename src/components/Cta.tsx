  ...
  return (
    <section className='section'>
      <div className='container'>
        ...
        overflow-hidden grid grid-cols-1 lg:grid-cols-[1fr,0.7fr] lg:items-center'
        >
          <div className='p-8 md:p-16 xl:p-20'>
            <motion.h2
              ...
              whileInView='end'
              viewport={{ once: true }}
              className='text-[26px] leading-tight font-semibold mb-6 capitalize
            sm:text-[34px] md:text-[40px] lg:text-[46px] lg:mb-10'
            >
              {ctaData.text}
            </motion.h2>
            <motion.div
